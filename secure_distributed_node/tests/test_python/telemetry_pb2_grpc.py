...
class TelemetryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamTelemetry = channel.unary_stream(
                ...
                request_serializer=telemetry__pb2.NodeStatusRequest.SerializeToString,
                response_deserializer=telemetry__pb2.TelemetrySample.FromString,
                _registered_method=True)
        self.GetNodeStatus = channel.unary_unary(
                '/telemetry.TelemetryService/GetNodeStatus',
                request_serializer=telemetry__pb2.NodeStatusRequest.SerializeToString,
                response_deserializer=telemetry__pb2.NodeStatus.FromString,
                _registered_method=True)
...
def add_TelemetryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamTelemetry': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=telemetry__pb2.NodeStatusRequest.FromString,
                    response_serializer=telemetry__pb2.TelemetrySample.SerializeToString,
            ),
            'GetNodeStatus': grpc.unary_unary_rpc_method_handler(
                    servicer.GetNodeStatus,
                    request_deserializer=telemetry__pb2.NodeStatusRequest.FromString,
                    response_serializer=telemetry__pb2.NodeStatus.SerializeToString,
            ),
    }
...
class TelemetryService(object):
    ...
    def StreamTelemetry(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/telemetry.TelemetryService/StreamTelemetry',
            telemetry__pb2.NodeStatusRequest.SerializeToString,
            telemetry__pb2.TelemetrySample.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetNodeStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/telemetry.TelemetryService/GetNodeStatus',
            telemetry__pb2.NodeStatusRequest.SerializeToString,
            telemetry__pb2.NodeStatus.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
