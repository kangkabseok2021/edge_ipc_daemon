...
def worker_node_stub():
    ...
    ca_cert   = open(os.path.join(certs, "ca.crt"),      "rb").read()
    node_cert = open(os.path.join(certs, "worker1.crt"), "rb").read()
    node_key  = open(os.path.join(certs, "worker1.key"), "rb").read()
